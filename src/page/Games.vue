...
<template>
  <main class="relative min-h-screen bg-gradient-to-b from-purple-900 via-indigo-900 to-black text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto py-16 px-6">
      ...
      <!-- Title -->
      <h1 class="text-4xl md:text-5xl font-extrabold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-400">
        Доступные игры
      </h1>
      ...
      <ul class="space-y-6">
        ...
        >
          <span class="text-lg font-semibold text-pink-300">Game #1 by Alice</span>
          <button
        ...
        <li
          class="bg-gradient-to-r from-indigo-900 via-purple-800 to-black p-6 rounded-2xl shadow-xl flex justify-between items-center hover:scale-105 transform transition cursor-pointer"
        >
          <span class="text-lg font-semibold text-purple-300">Game #2 by Bob</span>
          <button
            class="bg-blue-500 hover:bg-blue-600 py-2 px-5 rounded-full text-white font-medium shadow-lg transition transform hover:scale-105"
          >
            Join
        ...
        <li
          class="bg-gradient-to-r from-black via-purple-900 to-indigo-900 p-6 rounded-2xl shadow-xl flex justify-between items-center hover:scale-105 transform transition cursor-pointer"
        >
          <span class="text-lg font-semibold text-indigo-300">Game #3 by Charlie</span>
          <button
            class="bg-blue-500 hover:bg-blue-600 py-2 px-5 rounded-full text-white font-medium shadow-lg transition transform hover:scale-105"
          >
            Join
